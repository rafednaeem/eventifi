        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-pink-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-orange-500/30" aria-hidden="true">E</div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/event-builder" className="text-orange-600 hover:text-orange-700 font-bold flex items-center gap-1 transition-colors"><Sparkles className="w-4 h-4" aria-hidden="true" /> Event Builder</Link>
            ...
            <button
              ...
              className="md:hidden p-2 -mr-2 text-slate-600 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-colors active:scale-95"
            >
      ...
      <div className="relative pt-20 min-h-[85vh] flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-4 text-center mt-10">
          <span className="inline-block py-1.5 px-4 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-sm font-semibold mb-8 backdrop-blur-md">
            <span aria-hidden="true">✨</span> The #1 Marketplace for Events in Pakistan
          </span>
          ...
          {/* Search Bar */}
          <form action="/search" method="GET" className="bg-white p-2 rounded-2xl shadow-2xl max-w-4xl mx-auto flex flex-col md:flex-row gap-2 items-center transform hover:scale-[1.01] transition-all duration-300 focus-within:ring-4 focus-within:ring-orange-500/10">
            <div className="flex-1 w-full flex items-center px-4 h-14 bg-gray-50 rounded-xl border border-transparent hover:border-orange-200 focus-within:border-orange-300 focus-within:bg-white transition-all">
              <label htmlFor="city-input" className="sr-only">Location</label>
              <MapPin className="text-orange-500 w-5 h-5 mr-3 shrink-0" aria-hidden="true" />
              <input type="text" id="city-input" name="city" placeholder="Location (e.g. Lahore)" className="bg-transparent w-full outline-none text-slate-700 placeholder-slate-400 font-medium" />
            </div>
            <div className="hidden md:block w-px h-8 bg-gray-200"></div>
            <div className="flex-1 w-full flex items-center px-4 h-14 bg-gray-50 rounded-xl border border-transparent hover:border-orange-200 focus-within:border-orange-300 focus-within:bg-white transition-all">
              <label htmlFor="search-input" className="sr-only">Search venues or services</label>
              <Search className="text-orange-500 w-5 h-5 mr-3 shrink-0" aria-hidden="true" />
              <input type="text" id="search-input" name="q" placeholder="Search Venues or Services..." className="bg-transparent w-full outline-none text-slate-700 placeholder-slate-400 font-medium" />
            </div>
            <button type="submit" className="w-full md:w-auto px-10 h-14 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 active:scale-[0.98] text-white font-bold rounded-xl transition-all shadow-lg shadow-orange-500/30 flex items-center justify-center gap-2">
              Search
            </button>
          </form>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link href="/properties" className="hidden md:flex items-center text-orange-600 font-bold hover:text-orange-700 transition-colors">
              View All <ArrowRight className="ml-2 w-5 h-5" aria-hidden="true" />
            </Link>
          </div>
      ...
      <footer className="bg-slate-950 text-slate-400 py-16 border-t border-slate-900">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-4 text-white font-bold text-2xl">
            <div className="w-6 h-6 bg-orange-500 rounded" aria-hidden="true"></div> Eventifi
          </div>
