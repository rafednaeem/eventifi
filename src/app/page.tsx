        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button type="button" className="px-6 py-2.5 rounded-full bg-slate-900 text-white font-medium hover:bg-orange-600 transition-all duration-300 shadow-lg hover:shadow-orange-500/30 transform hover:-translate-y-0.5">
                Get Started
              </button>
            </div>
            {/* Mobile Menu Button */}
            <button type="button" aria-label="Toggle menu" className="md:hidden text-slate-600 hover:bg-slate-100 p-2 rounded-lg transition-all active:scale-95">
