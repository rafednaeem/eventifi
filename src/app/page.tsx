          ...
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-2 text-slate-600 hover:bg-slate-100 rounded-lg active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-orange-500 outline-none"
              >
      ...
      <div className="relative pt-20 min-h-[85vh] flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-4 text-center mt-10">
          ...
          <form
            action="/search"
            method="GET"
            className="bg-white p-2 rounded-2xl shadow-2xl max-w-4xl mx-auto flex flex-col md:flex-row gap-2 items-center transform hover:scale-[1.01] transition-all duration-300 focus-within:ring-4 focus-within:ring-orange-500/10 focus-within:scale-[1.01]"
          >
