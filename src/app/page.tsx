        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <button
              ...
              className="md:hidden text-slate-600 hover:bg-slate-100 p-2 rounded-lg active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-orange-500 outline-none"
            >
