        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button type="button" className="px-6 py-2.5 rounded-full bg-slate-900 text-white font-medium hover:bg-orange-600 active:scale-95 transition-all duration-300 shadow-lg hover:shadow-orange-500/30 transform hover:-translate-y-0.5">
                Get Started
              </button>
            </div>
            {/* Mobile Menu Button */}
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {serviceCategories?.map((category) => {
              ...
              return (
                <Link href={`/services/category/${category.slug}`} key={category.id} className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-3xl border border-slate-700 hover:border-orange-500/50 transition-all hover:bg-slate-800 active:scale-[0.99] group cursor-pointer block">
