                        ...
                        <div className="p-8 md:p-12">
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
                                ...
                                <div className="flex items-center gap-3">
                                    <Button variant="outline" aria-label="Share listing" className="rounded-2xl h-12 px-6 border-slate-200 text-slate-600 hover:bg-slate-50 active:scale-95 transition-all font-bold gap-2">
                                        <Share2 className="h-4 w-4" /> Share
                                    </Button>
                                    <Button variant="outline" aria-label="Add to favorites" className="rounded-2xl h-12 w-12 border-slate-200 text-slate-600 hover:bg-slate-50 active:scale-95 transition-all font-bold">
