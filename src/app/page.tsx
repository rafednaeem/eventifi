      ...
      <nav className="fixed w-full z-50 bg-white/85 backdrop-blur-md border-b border-gray-100 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            {/* Mobile Menu Button */}
            <button type="button" aria-label="Open mobile menu" className="md:hidden text-slate-600 p-2 -mr-2 hover:text-orange-600 transition-colors active:scale-95">
      ...
      <div className="relative pt-20 min-h-[85vh] flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-4 text-center mt-10">
          ...
          <form action="/search" method="GET" className="bg-white p-2 rounded-2xl shadow-2xl max-w-4xl mx-auto flex flex-col md:flex-row gap-2 items-center transform hover:scale-[1.01] transition-all duration-300 focus-within:ring-4 focus-within:ring-orange-500/10">
            <div className="flex-1 w-full flex items-center px-4 h-14 bg-gray-50 rounded-xl border border-transparent hover:border-orange-200 focus-within:border-orange-500 focus-within:bg-white transition-all">
