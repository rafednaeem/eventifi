        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {propertyCategories?.slice(0, 6).map((category, index) => {
              ...
              return (
                <Link href={`/properties/category/${category.slug}`} key={category.id} className="group relative h-96 rounded-[2rem] overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-500 block active:scale-[0.99]">
