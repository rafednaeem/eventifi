...
export function ListingCard({ listing }: ListingCardProps) {
    return (
        <Link
            ...
            className="group flex flex-col bg-white rounded-3xl border border-slate-200 overflow-hidden hover:shadow-2xl active:scale-[0.99] transition-all duration-300 hover:-translate-y-1 block"
        >
